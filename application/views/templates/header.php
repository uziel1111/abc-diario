              ...
              <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown nav-primary">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="DropEstadisticas">
                    ...
                    <a class="dropdown-item text-wrap" href="<?= base_url('Estadistica/estadistica_general/estado_municipio/alumnos'); ?>">Por estado / municipio</a>
                    <a class="dropdown-item text-wrap" href="<?= base_url('Estadistica/estadistica_general/zona_escolar/alumnos'); ?>">Por zona escolar</a>
                    <a class="dropdown-item text-wrap" href="<?= base_url('Info_escuela/busqueda_general/estadistica/escuela'); ?>">Por escuela</a>
                    <a class="dropdown-item text-wrap" href="<?= base_url('Riesgo_abandono/vista_principal_riesgo/estadistica'); ?>">Riesgo de abandono escolar por estado / municipio</a>
                    <a class="dropdown-item text-wrap" href="<?= base_url('Info_escuela/busqueda_general/estadistica/rescuela'); ?>">Riesgo de abandono por escuela</a>
                  </div>
                </li>
